...
public class QueueTest {
	...
	public void test_enqueue() {
		...
		try {
			...
			assertEquals("Bounded queue is full at size = 4. Call dequeue() " + "before recalling enqueue()",
					e.getMessage());
		}
		// assertEquals("Item has not been added into queue.", 105, (int)
		// this.queue.lastValue());
	}
	...
	public void test_dequeue() {
		try {
			...
			assertEquals("Bounded queue is currently empty. Call enqueue() " + "before dequeue()", e.getMessage());
		}
